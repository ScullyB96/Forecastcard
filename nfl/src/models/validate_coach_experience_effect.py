...
def build_coach_experience(schedules: pd.DataFrame) -> pd.DataFrame:
    reg = schedules[schedules["game_type"] == "REG"].sort_values(["season", "week", "game_id"]).reset_index(drop=True)
...
if __name__ == "__main__":
    ...
    exp = build_coach_experience(schedules)[
        ["game_id", "spread_line", "total_line", "home_coach_exp", "away_coach_exp"]
    ]
